...
export function exportPackageText(pkg: ExportPackage) {
  const summary = {
    ...
    files: ['README.md', 'package.json', 'src/GeneratedComponent.tsx', 'src/generatedSchema.json', 'src/designTokens.json', 'src/qualityReport.json', 'src/index.ts', 'src/GeneratedComponent.css'],
